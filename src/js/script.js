...
(function($) {
    ...
    var ListStore = {
        ...
        newItem: function(text, text1, status, label) {
            this.state.items.unshift({ text: text, text1: text1, status: status, label: label, isEditing: true });
        },
        load: function() {
    ...
    var TodoItem = Vue.extend({
        ...
        methods: {
            save: function() {
                if(this.tempText && this.descrText != '') {
                    this.model.text = this.tempText;
                    this.model.text1 = this.descrText;
            ...
            edit: function() {
                ...
                this.descrText = this.model.text1;
            },
            delete: function() {
